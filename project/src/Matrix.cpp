...
namespace dae {
	...
	{
		Matrix transMat{ Vector4{1,0,0,x},Vector4{0,1,0,y}, Vector4{0,0,1,z},{0,0,0,1} };
	...
	{
		Matrix rotMat{ Vector4{1,0,0,0}, Vector4{0,cosf(pitch),-sinf(pitch),0},Vector4{0,sinf(pitch),cosf(pitch),0},Vector4{0,0,0,1 } };
		//throw std::runtime_error("Not Implemented Yet");
		return {rotMat};
	}
	...
	{
		Matrix rotMat{ Vector4{cosf(yaw),0,sinf(yaw),0}, Vector4{0,1,0,0},Vector4{-sinf(yaw),0,cosf(yaw),0},Vector4{0,0,0,1 } };
		//throw std::runtime_error("Not Implemented Yet");
		return {rotMat};
	}
	...
	{
		Matrix rotMat{ Vector4{cosf(roll),-sinf(roll),0,0}, Vector4{sinf(roll),cosf(roll),0,0},Vector4{0,0,1,0},Vector4{0,0,0,1 } };
		//throw std::runtime_error("Not Implemented Yet");
		return {rotMat};
	}
	...
	{
		Matrix totalRotMat{ CreateRotationX(r.x) * CreateRotationY(r.y) * CreateRotationZ(r.z) };
		//throw std::runtime_error("Not Implemented Yet");
		return {totalRotMat};
	}
	...
	{
		Matrix transMat{ Vector4{sx,0,0,0},Vector4{0,sy,0,0}, Vector4{0,0,sz,0},{0,0,0,1} };
		//throw std::runtime_error("Not Implemented Yet");	
		return { transMat };
	}
